...
requestBody: UserCreate,
     ...
     * @throws ApiError
     */
    public static readUserMe(): Promise<UserOut> {
        const token = localStorage.getItem('access_token') !== null ? localStorage.getItem('access_token') : "";
        const formData : {"access_token": string, "token_type": string} = {"access_token": token??"", "token_type": "bearer"};
